...
class FilmControllerTest {
    ...
    void shouldReturnValidationExceptionOnTooLongDescription() {
        ...
        Assertions.assertEquals("{\"message\":\"Не удалось добавить фильм: описание не должно превышать " + descriptionMaxLength + " символов; \"}", postResponse.getBody());
    }
    ...
    void shouldReturnListOfMostPopularFilms() {
        ...
        ResponseEntity<List<Film>> getResponse = restTemplate.exchange("/films/popular?count=3",
                HttpMethod.GET,
                null,
